...
namespace B2b.Web.v4.Models.Log.EPayment
{
    ...
    public class EPaymentLog
    {
        ...
        {
            string key = "cNqXTA" + Token.ChangeCharacter(Helper.GlobalSettings.CompanyName) + "nFmRq";
            CompanyName = Token.ChangeCharacter(Helper.GlobalSettings.CompanyName);
            ...
            CustomerCode = Token.Encrypt(log.CustomerCode, key);
            CustomerId = log.CustomerId;
            _3DSecure = log._3DSecure;
            Description =log.Explanation;
            PhoneNumber = log.PhoneNumber;
            SalesmanId = log.SalesmanId;
