...
namespace B2b.Web.v4.Models.EntityLayer
{
    ...
    public class PosInstallment : DataAccess
    {
        ...
        public static List<PosInstallment> GetInstallmentList(int pBankId, double pTotal, int pCustomerId, int pSpecialInstallment, int pPosBankId)
        {
            List<PosInstallment> list = new List<PosInstallment>();
            DataTable dt = DAL.GetInstallmentList(pBankId, pTotal, pCustomerId, pSpecialInstallment, pPosBankId);
        ...
        {
            List<PosInstallment> list = new List<PosInstallment>();
            DataTable dt = DAL.GetInstallmentByPosBankId(pPosBankId);
        ...
        {
            List<PosInstallment> list = new List<PosInstallment>();
            DataTable dt = DAL.GetListBankCardType();
        ...
        public static List<PosInstallment> GetListInstalmentByCardType(string pType, int pBankId, int pPosBankId)
        {
            List<PosInstallment> list = new List<PosInstallment>();
            DataTable dt = DAL.GetListInstalmentByCardType(pType, pBankId,pPosBankId);
    ...
    public partial class DataAccessLayer
    {
        ...
        public DataTable GetListInstalmentByCardType(string pType, int pBankId, int pPosBankId)
        {
            return DatabaseContext.ExecuteReader(CommandType.StoredProcedure, "_GetList_InstallmentCount_ByCardType_1", MethodBase.GetCurrentMethod().GetParameters(), new object[] { pType, pBankId, pPosBankId });
        }


        public DataTable GetInstallmentList(int pBankId, double pTotal, int pCustomerId, int pSpecialInstallment, int pPosBankId)
        {
            return DatabaseContext.ExecuteReader(CommandType.StoredProcedure, "_Pos_Payment_GetList_InstallmentByBankId", MethodBase.GetCurrentMethod().GetParameters(), new object[] { pBankId, pTotal, pCustomerId, pSpecialInstallment, pPosBankId });
        }
