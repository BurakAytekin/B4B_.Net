adminApp.controller('paymentDetailController', ['$scope', '$http', 'NgTableParams', function ($scope, $http, NgTableParams) {
    ...
    $scope.loadPosOfBankData = function () {
        ...
        $http({
            method: "POST",
            url: "/Admin/Payment/GetPosOfBankList",
    ...
    $scope.loadPosBankDetail = function () {
        ...
        $http({
            method: "POST",
            url: "/Admin/Payment/GetPosBankDetail",
            headers: { "Content-Type": "Application/json;charset=utf-8" },
            data: { posBankId: $scope.selectedPosBankId }
    ...
    $scope.changeSwitch = function (posItem) {
        ...
        $http({
            method: "POST",
            url: "/Admin/Payment/UpdatePosOfBank",
            headers: { "Content-Type": "Application/json;charset=utf-8" },
    ...
    $scope.loadPosInstallment = function () {
        ...
        $http({
            method: "POST",
            url: "/Admin/Payment/GetPosInstallment",
            headers: { "Content-Type": "Application/json;charset=utf-8" },
            data: { posBankId: $scope.selectedPosBankId }
    ...
    $scope.saveDetailItem = function () {
        ...
        $http({
            method: "POST",
            url: "/Admin/Payment/SaveDetailItem",
            headers: { "Content-Type": "Application/json;charset=utf-8" },
